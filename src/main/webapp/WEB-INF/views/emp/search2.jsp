			...
			<table id="tbl-search">
				...
				<tr>
					...
					<td>
						...
						<input type="radio" name="salaryCompare" id="salaryComapre1" value="ge" ${param.salaryCompare eq 'ge' ? 'checked' : ''}/>
						<label for="salaryCompare1">이상</label>
						<input type="radio" name="salaryCompare" id="salaryComapre2" value="le" ${param.salaryCompare eq 'le' ? 'checked' : ''}/>
	...
	<table class="tbl-emp">
		...
		<tbody>
			<c:if test="${empty list}">
				<tr><td colspan="15">검색결과가 존재하지 않습니다.</td></tr>
			</c:if>
